...
suite "spaces":
  ...
  test "More space transformations - compared with R colorspace output":
    ...
    let expOklab = [
      oklab(0.60590756, -0.06188381, -0.13194072),
      oklab(0.76736802,  0.00318307, -0.05600452),
      oklab(0.85227680,  0.00364283, -0.02969652),
      oklab(0.91291428,  0.00197440, -0.01289052),
      oklab(0.95215142,  0.00022322, -0.00258791),
      oklab(0.95250702,  0.00263089,  0.00014657),
      oklab(0.91443777,  0.01454172,  0.00162882),
      oklab(0.85368145,  0.03476316,  0.00259757),
      oklab(0.76249129,  0.06782311,  0.00173593),
      oklab(0.56072861,  0.20166340, -0.03378892)
    ]
    for i in 0 ..< colors.len:
    ...
    let expPolarOklab = [
      polarOklab(0.60590756, 0.14573249, 244.87213135),
      polarOklab(0.76736802, 0.05609491, 273.25296021),
      polarOklab(0.85227680, 0.02991912, 276.99343872),
      polarOklab(0.91291428, 0.01304085, 278.70816040),
      polarOklab(0.95215142, 0.00259752, 274.92980957),
      polarOklab(0.95250702, 0.00263497,   3.18867302),
      polarOklab(0.91443777, 0.01463265,   6.39105606),
      polarOklab(0.85368145, 0.03486007,   4.27331066),
      polarOklab(0.76249129, 0.06784532,   1.46615958),
      polarOklab(0.56072861, 0.20447449, 350.48837280)
    ]
    for i in 0 ..< colors.len:
